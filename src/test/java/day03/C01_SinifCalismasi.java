...
public class C01_SinifCalismasi {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //2.YOL : driver.findElement(By.linkText("Sign in")).click();
        ...
        Thread.sleep(2000);
        signin.click(); // Sign in i daha once locate ettigimiz icin direkt click dedik
        ...
        //5. Linkleri LAMBDA ile yazdırınız (2. yol)
